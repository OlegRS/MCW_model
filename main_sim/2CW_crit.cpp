...
int main() {
  ...
  cout << "../data/2CW_model/h1_scanning/2CW__J11" + to_string(J11) + "__J22_" + to_string(J22) + "__J12_" + to_string(J12) + "__H1_START_" + to_string(H1_START) + "__H1_FIN_" + to_string(H1_FIN) + "__H1_STEP_"  + to_string(H1_STEP) + "__H2_" + to_string(H2) + "__N1_" + to_string(N1)+ "__N2_" + to_string(N2) + "__ITERS_PER_NODE_" + to_string(N_ITERS_PER_NODE) + "__N_AVRGING_" + to_string(N_AVRGING) + "__RANDOM_INITIALISATION_" + to_string(INITIALISE_RANDOMLY) + "__N_DYNAMIC_NODES_" + to_string(N_DYNAMIC_NODES) +".csv\n";
  ofstream ofs("../data/2CW_model/h1_scanning/2CW__J11" + to_string(J11) + "__J22_" + to_string(J22) + "__J12_" + to_string(J12) + "__H1_START_" + to_string(H1_START) + "__H1_FIN_" + to_string(H1_FIN) + "__H1_STEP_"  + to_string(H1_STEP) + "__H2_" + to_string(H2) + "__N1_" + to_string(N1)+ "__N2_" + to_string(N2) + "__ITERS_PER_NODE_" + to_string(N_ITERS_PER_NODE) + "__N_AVRGING_" + to_string(N_AVRGING) + "__RANDOM_INITIALISATION_" + to_string(INITIALISE_RANDOMLY) + "__N_DYNAMIC_NODES_" + to_string(N_DYNAMIC_NODES) +".csv");
